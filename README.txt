...
Replace 'dx = ...' and 'dy = ...' with your equations of state, and run the 'main.py' script either in your IDE of choice, or in the terminal with the command 'python3 mainn.py'. 
